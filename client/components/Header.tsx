  ...
  return (
    <div className=" max-w-5xl w-full mx-auto mt-32 md:pt-14">
      <div className=" md:flex justify-center items-center gap-7 my-7">
        ...
        {/* Description */}
        <div className=" relative text-center px-4 text-gray-900 dark:text-gray-100 mt-4 max-w-2xl mx-auto">
          <h1 className=" text-3xl md:text-6xl font-bold">
            {text}
            <span className=" text-2xl text-black">
              <Cursor
                cursorStyle={
                  <FaBug className="text-black dark:text-white/80 ant-cursor absolute top-0" />
                }
              />
            </span>
          </h1>
          <p className=" mt-7 text-sm md:text-xl font-medium text-gray-800/70 dark:text-gray-100 space-x-5">
          ...
          <div className=" flex flex-row gap-2 justify-center items-center md:gap-6 mt-4 text-gray-800/70 dark:text-gray-100">
          ...
          <div className=" mt-6 flex justify-center gap-3">
            <a
              ...
              className=" px-3 py-1 bg-gray-800 dark:bg-gray-700 font-medium text-sm text-white dark:text-gray-100 rounded-md flex items-center gap-3 shadow-sm"
            >
            ...
            <Link
              ...
              className=" px-3 py-1 border dark:border-gray-700 font-medium text-sm text-gray-800 dark:text-gray-100 rounded-md flex items-center gap-3 shadow-sm"
            >
